...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Examples03-car_animation) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; header: (define (tick x) x)
; template: (define (tick x) (... x ...))
(define (tick x)
  (if (> x (+ WIDTH-OF-SCENE 50)) (- x (- x 50)) (+ x 3)))
